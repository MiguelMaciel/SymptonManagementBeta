package org.magnum.sympton;

import org.magnum.sympton.auth.OAuth2SecurityConfiguration;
import org.magnum.sympton.json.ResourcesMapper;
import org.magnum.sympton.repository.AlarmingSymptons;
...
import org.magnum.sympton.repository.Medication;
...
public class Application extends RepositoryRestMvcConfiguration {
	...
	protected void configureRepositoryRestConfiguration(
		...
		config.exposeIdsFor(AlertMedication.class);
		config.exposeIdsFor(CheckIn.class);
		config.exposeIdsFor(CheckInMedication.class);
		config.exposeIdsFor(AlarmingSymptons.class);
	}
