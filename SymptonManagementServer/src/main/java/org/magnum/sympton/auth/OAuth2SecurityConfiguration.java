package org.magnum.sympton.auth;
	...
	protected static class OAuth2Config extends
		...
		public OAuth2Config() throws Exception {
			...
			ClientDetailsService csvc = new InMemoryClientDetailsServiceBuilder()
					...
					.scopes("read","write").resourceIds("patient", "doctor", "medicine", 
							"checkin", "medication", "alertmedication")//tava so patient
					.and()
			...
			UserDetailsService svc = new InMemoryUserDetailsManager(
					Arrays.asList(
							User.create("doc1", "pass", "DOCTOR"),
							User.create("doc2", "pass", "DOCTOR"),
							User.create("doc3", "pass", "DOCTOR"),
							User.create("pat1", "pass", "PATIENT"),
							User.create("pat2", "pass", "PATIENT"),
							User.create("pat3", "pass", "PATIENT"),
							User.create("pat4", "pass", "PATIENT")));
